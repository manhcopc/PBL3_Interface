...
public partial class StaffPage : ContentPage
{
    ...
    private void OnRoleClicked(object sender, EventArgs e)
    {
        ...
        RoleAll.BackgroundColor = button.Text == "Tất cả" ? Color.FromHex("#C6E2FF") : Color.FromHex("#FFE4B5");
        RoleCashier.BackgroundColor = button.Text == "Thu ngân" ? Color.FromHex("#C6E2FF") : Color.FromHex("#FFE4B5");
        RoleBartender.BackgroundColor = button.Text == "Pha chế" ? Color.FromHex("#C6E2FF") : Color.FromHex("#FFE4B5");
        RoleWaiter.BackgroundColor = button.Text == "Phục vụ" ? Color.FromHex("#C6E2FF") : Color.FromHex("#FFE4B5");
    }
    ...
    private void OnSaveStaffClicked(object sender, EventArgs e)
    {
            ...
            !string.IsNullOrWhiteSpace(StaffRoleEntry.Text))
        {
            var frame = new Frame
            {
                ...
                Padding = 10,
                BackgroundColor = Color.FromHex("#F8E0E0"),
